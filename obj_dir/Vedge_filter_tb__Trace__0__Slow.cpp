...
VL_ATTR_COLD void Vedge_filter_tb___024root__trace_init_sub__TOP__0(Vedge_filter_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+30,0,"IMG_W",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+31,0,"IMG_H",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+32,0,"NPIX",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+28,0,"pixel_grey",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+10,0,"pixel_edge",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBit(c+11,0,"out_ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+28,0,"grey_data",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+10,0,"edge_data",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBit(c+11,0,"out_ready",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+12,0,"col",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
    ...
    tracep->popPrefix();
    tracep->declBus(c+22,0,"gx",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+23,0,"gy",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+24,0,"mag",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+25,0,"ready_shift",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    ...
    tracep->declBus(c+28,0,"pixel_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBit(c+3,0,"in_ready",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+29,0,"gray_temp",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vedge_filter_tb___024root__trace_const_0_sub_0(Vedge_filter_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+30,(0x280U),32);
    bufp->fullIData(oldp+31,(0x1e0U),32);
    bufp->fullIData(oldp+32,(0x4b000U),32);
}
...
VL_ATTR_COLD void Vedge_filter_tb___024root__trace_full_0_sub_0(Vedge_filter_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+10,((0xfU & (IData)(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__mag))),4);
    bufp->fullBit(oldp+11,((1U & ((IData)(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__ready_shift) 
                                  >> 2U))));
    bufp->fullIData(oldp+12,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__col),32);
    bufp->fullCData(oldp+13,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_top[0]),4);
    bufp->fullCData(oldp+14,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_top[1]),4);
    bufp->fullCData(oldp+15,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_top[2]),4);
    bufp->fullCData(oldp+16,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_mid[0]),4);
    bufp->fullCData(oldp+17,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_mid[1]),4);
    bufp->fullCData(oldp+18,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_mid[2]),4);
    bufp->fullCData(oldp+19,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_bot[0]),4);
    bufp->fullCData(oldp+20,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_bot[1]),4);
    bufp->fullCData(oldp+21,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__shift_bot[2]),4);
    bufp->fullCData(oldp+22,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__gx),8);
    bufp->fullCData(oldp+23,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__gy),8);
    bufp->fullCData(oldp+24,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__mag),8);
    bufp->fullCData(oldp+25,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__ready_shift),3);
    bufp->fullIData(oldp+26,(vlSelfRef.edge_filter_tb__DOT__edge_dut__DOT__unnamedblk1__DOT__i),32);
    bufp->fullBit(oldp+27,(vlSelfRef.edge_filter_tb__DOT__clk));
    bufp->fullCData(oldp+28,(vlSelfRef.edge_filter_tb__DOT__pixel_grey),4);
    bufp->fullCData(oldp+29,(vlSelfRef.edge_filter_tb__DOT__rgb_dut__DOT__gray_temp),8);
}
